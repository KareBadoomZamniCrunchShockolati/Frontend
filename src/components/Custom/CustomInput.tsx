            ...
            <div className="relative w-full">
              {as === "textarea" ? (
                ...
                <Input
                  ...
                  onBlur={handleBlur}
                  dir={isRTL ? "rtl" : "ltr"}
                  className={`border text-foreground !border-[var(--foreground)] shadow-[0px_1px_0px_var(--foreground)] focus:!border-[var(--borderFoucus)] focus:!shadow-[0px_1px_0px_var(--borderFoucusShadow)] focus:!ring-0 focus-visible:!ring-0 p-0 rounded-primary-radius h-10 w-full
                    ${isRTL ? "text-right pr-4" : "text-left pl-4"}
                    ${icon ? "pl-12" : ""}
                    transition-all duration-200 ease-in-out
                    ${
              ...
              {icon && (
                <div
                  className={`absolute top-1/2 -translate-y-1/2 text-gray-text cursor-pointer
                    ${"left-4"}`}
                  onClick={onIconClick}
                >
                  {icon}
