...
const CustomButton = ({
  ...
  return (
    <Button
      ...
      {...(type ? { type } : {})}
      onClick={handleClick}
      className={`${width} hover:${backgroundColor} sm:text-sm md:text-base cursor-pointer ${height} sm:h-10 rounded-xl text-white font-bold ${backgroundColor} active:shadow-none active:translate-y-[3px] shadow-[0_3px_0px_0px_rgba(0,0,0,1)] transition-all duration-25 border-2 border-black ${className} `}
