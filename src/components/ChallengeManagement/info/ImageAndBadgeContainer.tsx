  ...
  return (
    <div className="relative w-full max-w-xl mb-4">
      <img
        ...
        className="w-full h-auto rounded-primary-radius shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shadow-foreground"
      />
      <div className="absolute h-11 bottom-[-10px] right-[-0px] bg-secondary border-1 border-black p-1 rounded-[8px] flex space-x-2 items-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shadow-foreground">
