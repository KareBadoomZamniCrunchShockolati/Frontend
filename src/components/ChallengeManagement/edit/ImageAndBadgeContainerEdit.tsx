  ...
  return (
    <div className="relative w-full max-w-xl mb-4 mt-4">
      ...
      <img
        ...
        className="w-full h-auto rounded-primary-radius shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shadow-foreground filter blur-xs"
      />

      {/* Badge container */}
      <div className="absolute h-11 bottom-[-10px] right-[-0px] bg-secondary border-1 border-black p-1 rounded-primary-radius flex space-x-2 items-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] shadow-foreground">
