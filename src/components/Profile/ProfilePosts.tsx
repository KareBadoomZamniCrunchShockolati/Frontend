...
export const posts: Post[] = [
  ...
  },
  {
    ...
    text: "ساعت 5 صبح برقان درود به شرفت میو میو موی سلام سلام همگی سلام ماو ماو ماو عیسی داداش  ورزش روزانه و شروع یک روز عالی ",
    challenge: {
      id: 1,
      challengeTitle: "چالش تناسب اندام",
    },
  },
  {
    id: 4,
    imageUrl: "https://picsum.photos/id/1035/600/750",
  ...
  {
    id: 6,
    imageUrl: "https://picsum.photos/id/1062/500/500",
    text: "قهوه داغ صبحگاهی",
    challenge: {
      id: 2,
      challengeTitle: "چالش ۳۰ روز صبح زود بیدار شدن",
    },
  },
  {
    id: 7,
  ...
  {
    id: 8,
    imageUrl: "https://picsum.photos/id/180/600/900",
  ...
  },
  {
    ...
    challenge: {
      id: 3,
      challengeTitle: "چالش کتاب‌خوانی",
    },
  },
  {
    id: 11,
  ...
  {
    id: 12,
    imageUrl: "https://picsum.photos/id/1079/700/900",
  ...
  {
    id: 18,
    imageUrl: "https://picsum.photos/id/1057/600/900",
    text: "ساحل آرام و موج‌های آرام",
    challenge: {
      id: 5,
      challengeTitle: "چالش مراقبت از خود",
    },
  },
  {
    id: 19,
  ...
  },
  {
    ...
    challenge: {
      id: 6,
      challengeTitle: "چالش ۱۰ هزار قدم",
    },
  },
  {
    id: 23,
  ...
  },
  {
    ...
    challenge: {
      id: 7,
      challengeTitle: "چالش لحظه‌شناسی",
    },
  },
  {
    id: 26,
  ...
  {
    id: 28,
    imageUrl: "https://picsum.photos/id/1019/500/600",
  ...
  },
  {
    ...
    challenge: {
      id: 8,
      challengeTitle: "چالش مراقبت از گیاه",
    },
  },
  {
    id: 30,
    imageUrl: "https://picsum.photos/id/1016/600/700",
      ...
      <div className="columns-2 sm:columns-3 md:columns-4 gap-3 p-3">
        {postSkeleton.map((post) => (
          <div key={post.id} className="break-inside-avoid mb-3">
            <Card className="overflow-hidden rounded-[12.5px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-black hover:shadow-2xl hover:opacity-90 transition cursor-pointer">
  ...
  return (
    ...
    <div className="columns-2 sm:columns-3 md:columns-4 gap-3 p-3">
      {posts.map((post) => (
        <div key={post.id} className="break-inside-avoid mb-3">
          <Card
            className="overflow-hidden rounded-[12.5px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-black hover:shadow-2xl hover:opacity-90 transition cursor-pointer"
